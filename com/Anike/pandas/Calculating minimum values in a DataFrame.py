...
marksUTMishti= marksUT.loc[marksUT.Name== 'Mishti']
print('Marks obtained by the student Mishti in all unit tests for each subject:\n')
print(marksUTMishti)
print('\n')

print('Minimum marks obtained by the student Mishti in all unit tests for each subject:\n')
print(marksUTMishti.min())
print('\n')
